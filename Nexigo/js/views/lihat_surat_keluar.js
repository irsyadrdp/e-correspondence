        ...
        fields: [
            {
                ...
                offset: 5,
                cols: 4,
                text: '<div style="text-align: left; font-weight: normal;">Surat Keluar : <b><span id="nomor_surat1"></span></b></div> ',
                fields: [
                    {
                        type: 'content',
                        content: [
                            ...
                            "Direktorat : <b><span id='direktorat'></span></b><br/>",
        ...
        init: function (xg, cb) {
            ...
            xg.ajax({
                ...
                success: function (data) {
                    ...
                    $('#direktorat').html(data.data.Direktorat);
                    $('#penerima').html(data.data.penerima);
